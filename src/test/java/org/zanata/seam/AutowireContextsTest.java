...
public class AutowireContextsTest {
    ...
    public void putComponentInRequestScope() {
        String val = "A string!";
        String name = "test";
        AutowireContexts.getInstance().putValue(name,
                AutowireContexts.ContextType.Request, val);

        // Make sure it's there
        assertThat((String) AutowireContexts.getInstance().getValue(name),
                is(val));
    }
    ...
    public void putComponentInTwoScopes() {
        ...
        AutowireContexts.getInstance().putValue(name,
                AutowireContexts.ContextType.Request, requestVal);
        AutowireContexts.getInstance().putValue(name,
                AutowireContexts.ContextType.Session, sessionVal);
